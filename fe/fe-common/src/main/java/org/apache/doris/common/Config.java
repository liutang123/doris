...
public class Config extends ConfigBase {
    ...
    @ConfField(description = {"是否启用 mysql 连接中的 TCP keep alive，默认启用",
            "Whether to enable TCP Keep-Alive for MySQL connections, enabled by default"})
    public static boolean mysql_nio_enable_keep_alive = true;
