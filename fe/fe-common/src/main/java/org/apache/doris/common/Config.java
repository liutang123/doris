...
public class Config extends ConfigBase {
    ...
    @ConfField(mutable = true, masterOnly = true)
    public static int max_running_txn_replica_num_per_db = -1;

    /**
     * maximum concurrent running txn num including prepare, commit txns under a single table
     * txn manager will reject coming txns
     */
    @ConfField(mutable = true, masterOnly = true)
    public static int max_running_txn_num_per_table = -1;
