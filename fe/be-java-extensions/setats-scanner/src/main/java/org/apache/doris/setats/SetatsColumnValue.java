...
public class SetatsColumnValue implements ColumnValue {
    private static final Logger LOG = LoggerFactory.getLogger(SetatsColumnValue.class);
    private int idx;
    private RowData record;
    private ColumnType dorisType;

    public SetatsColumnValue() {
    }

    public SetatsColumnValue(RowData record, int idx, ColumnType columnType) {
        this.idx = idx;
        this.record = record;
    ...
    public void setOffsetRow(RowData record) {
        this.record = record;
    }
