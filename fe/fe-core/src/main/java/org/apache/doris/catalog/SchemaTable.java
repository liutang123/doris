    ...
    public static Map<String, Table> TABLE_MAP = ImmutableMap.<String, Table>builder().put("tables",
            ...
            .put("user_privileges", new SchemaTable(SystemIdGenerator.getNextId(), "user_privileges", TableType.SCHEMA,
                    builder().column("GRANTEE", ScalarType.createVarchar(GRANTEE_len))
                            ...
                            .column("PRIVILEGE_TYPE", ScalarType.createVarchar(PRIVILEGE_TYPE_LEN))
                            .column("IS_GRANTABLE", ScalarType.createVarchar(IS_GRANTABLE_LEN)).build()))
            .put("data_skew", new SchemaTable(SystemIdGenerator.getNextId(), "data_skew", TableType.SCHEMA,
                    builder().column("CATALOG_NAME", ScalarType.createVarchar(NAME_CHAR_LEN))
                            ...
                            .column("PARTITIONNAME", ScalarType.createVarchar(NAME_CHAR_LEN))
                            .column("BUCKETIDX", ScalarType.createType(PrimitiveType.BIGINT))
                            .column("AVGROWCOUNT", ScalarType.createType(PrimitiveType.BIGINT))
                            .column("AVGDATASIZE", ScalarType.createType(PrimitiveType.BIGINT))
                            .column("GRAPH", ScalarType.createVarchar(200))
                            .column("PERCENT", ScalarType.createVarchar(100)).build()))
            .put("olap_tables", new SchemaTable(SystemIdGenerator.getNextId(), "olap_tables", TableType.SCHEMA,
                    builder().column("CATALOG_NAME", ScalarType.createVarchar(NAME_CHAR_LEN))
                            ...
                            .column("COMPRESS_TYPE", ScalarType.createVarchar(NAME_CHAR_LEN))
                            .column("INDEX_COUNT", ScalarType.createType(PrimitiveType.BIGINT))
                            .column("ROW_COUNT", ScalarType.createType(PrimitiveType.BIGINT))
                            .column("REPLICA_COUNT", ScalarType.createType(PrimitiveType.BIGINT))
                            .column("TABLETS_COUNT", ScalarType.createType(PrimitiveType.BIGINT))
                            .column("BUCKET_NUM", ScalarType.createType(PrimitiveType.BIGINT))
                            .column("PARTITION_NUM", ScalarType.createType(PrimitiveType.BIGINT))
                            .column("AUTO_PARTITION", ScalarType.createType(PrimitiveType.BOOLEAN))
                            .column("DYNAMIC_PARTITION", ScalarType.createType(PrimitiveType.BOOLEAN))
                            .column("DYNAMIC_PARTITION_TIME_UNIT", ScalarType.createVarchar(NAME_CHAR_LEN))
                            .column("DYNAMIC_PARTITION_START", ScalarType.createType(PrimitiveType.BIGINT))
                            .column("DYNAMIC_PARTITION_END", ScalarType.createType(PrimitiveType.BIGINT))
                            .column("TABLE_SIZE", ScalarType.createType(PrimitiveType.BIGINT))
                            .column("TABLE_LENGTH", ScalarType.createType(PrimitiveType.BIGINT))
                            .column("REMOTE_SIZE", ScalarType.createType(PrimitiveType.BIGINT))
                            .column("AVG_ROW_LENGTH", ScalarType.createType(PrimitiveType.BIGINT))
                            .column("CREATE_TIME", ScalarType.createType(PrimitiveType.DATETIME))
                            .column("UPDATE_TIME", ScalarType.createType(PrimitiveType.DATETIME))
                            ...
                            .column("IS_DATA_SKEW", ScalarType.createType(PrimitiveType.BOOLEAN)).build()))
            .put("olap_partitions", new SchemaTable(SystemIdGenerator.getNextId(), "olap_partitions", TableType.SCHEMA,
                   builder().column("CATALOG_NAME", ScalarType.createVarchar(NAME_CHAR_LEN))
                            .column("TABLE_SCHEMA", ScalarType.createVarchar(NAME_CHAR_LEN))
                            .column("TABLE_NAME", ScalarType.createVarchar(NAME_CHAR_LEN))
                            .column("TABLE_ID", ScalarType.createType(PrimitiveType.BIGINT))
                            ...
                            .column("LOCAL_DATA_SIZE", ScalarType.createType(PrimitiveType.BIGINT))
                            .column("REMOTE_DATA_SIZE", ScalarType.createType(PrimitiveType.BIGINT))
                            .column("BUCKET_COUNT", ScalarType.createType(PrimitiveType.BIGINT))
                            .column("REPLICA_COUNT", ScalarType.createType(PrimitiveType.BIGINT))
                            .column("COMMITTED_VERSION", ScalarType.createType(PrimitiveType.BIGINT))
                            .column("VISIABLE_VERSION", ScalarType.createType(PrimitiveType.BIGINT))
                            .column("VISIABLE_VERSION_TIME", ScalarType.createType(PrimitiveType.DATETIME))
                            .column("AVG_BUCKET_SIZE", ScalarType.createType(PrimitiveType.BIGINT)).build()))
            .put("transactions", new SchemaTable(SystemIdGenerator.getNextId(), "transactions", TableType.SCHEMA,
                    builder().column("TRANSACTION_ID", ScalarType.createType(PrimitiveType.BIGINT))
                            .column("LABEL", ScalarType.createVarchar(NAME_CHAR_LEN))
                            .column("REQUEST_ID", ScalarType.createVarchar(NAME_CHAR_LEN))
                            .column("USER", ScalarType.createVarchar(NAME_CHAR_LEN))
                            .column("COORDINATOR", ScalarType.createVarchar(NAME_CHAR_LEN))
                            .column("STATE", ScalarType.createVarchar(NAME_CHAR_LEN))
                            .column("SOURCE_TYPE", ScalarType.createVarchar(NAME_CHAR_LEN))
                            .column("DB_ID", ScalarType.createType(PrimitiveType.BIGINT))
                            .column("DB_NAME", ScalarType.createVarchar(2048))
                            .column("TABLEID_LIST", ScalarType.createVarchar(2048))
                            .column("TABLE_NAME", ScalarType.createVarchar(2048))
                            .column("PREPARE_TIME", ScalarType.createType(PrimitiveType.DATETIME))
                            .column("PRECOMMIT_TIME", ScalarType.createType(PrimitiveType.DATETIME))
                            .column("COMMIT_TIME", ScalarType.createType(PrimitiveType.DATETIME))
                            .column("PUBLISH_COUNT", ScalarType.createType(PrimitiveType.BIGINT))
                            .column("PUBLISH_VERSION_TIME", ScalarType.createType(PrimitiveType.DATETIME))
                            .column("FINISH_TIME", ScalarType.createType(PrimitiveType.DATETIME))
                            .column("REASON", ScalarType.createVarchar(2048))
                            .column("ERROR_REPLICAS", ScalarType.createType(PrimitiveType.BIGINT))
                            .column("CALLBACK_ID", ScalarType.createType(PrimitiveType.BIGINT))
                            .column("TIMEOUT_MS", ScalarType.createType(PrimitiveType.BIGINT))
                            .column("IS_PARTITIAL_UPDATE", ScalarType.createType(PrimitiveType.BOOLEAN))
                            .column("ERR_MSG", ScalarType.createVarchar(2048)).build()))
