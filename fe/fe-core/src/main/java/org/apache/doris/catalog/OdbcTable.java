...
public class OdbcTable extends Table {
     ...
     *
     * Rules:
     * - MYSQL: Wrap with backticks (`), case unchanged. Example: mySchema.myTable -> `mySchema.myTable`
     * - SQLSERVER: Wrap with square brackets ([]), case unchanged. Example: mySchema.myTable -> [mySchema].[myTable]
     * - POSTGRESQL, CLICKHOUSE, TRINO, SAP_HANA: Wrap with double quotes ("), case unchanged.
