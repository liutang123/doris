...
public class Coordinator implements CoordInterface {
    ...
    protected void computeFragmentHosts() throws Exception {
        ...
        boolean preferCN = !Config.isCloudMode() && ConnectContext.get() != null
        ...
        for (int i = fragments.size() - 1; i >= 0; --i) {
            ...
            if (!(leftMostNode instanceof ScanNode)) {
                ...
                if (!success) { // fallback to original
                    computeInstancePreferInput(fragment, exchangeInstances, params, inputFragmentId, useSerialSource);
                }
