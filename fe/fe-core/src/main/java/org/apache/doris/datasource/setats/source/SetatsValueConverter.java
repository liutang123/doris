...
import com.tencent.oceanus.shaded.org.apache.flink.table.data.DecimalData;
import com.tencent.oceanus.shaded.org.apache.flink.table.data.TimestampData;
import com.tencent.oceanus.shaded.org.apache.flink.table.data.binary.BinaryStringData;
import com.tencent.oceanus.shaded.org.apache.flink.table.types.logical.BigIntType;
import com.tencent.oceanus.shaded.org.apache.flink.table.types.logical.BooleanType;
import com.tencent.oceanus.shaded.org.apache.flink.table.types.logical.CharType;
import com.tencent.oceanus.shaded.org.apache.flink.table.types.logical.DateType;
import com.tencent.oceanus.shaded.org.apache.flink.table.types.logical.DecimalType;
import com.tencent.oceanus.shaded.org.apache.flink.table.types.logical.DoubleType;
import com.tencent.oceanus.shaded.org.apache.flink.table.types.logical.FloatType;
import com.tencent.oceanus.shaded.org.apache.flink.table.types.logical.IntType;
import com.tencent.oceanus.shaded.org.apache.flink.table.types.logical.LogicalType;
import com.tencent.oceanus.shaded.org.apache.flink.table.types.logical.SmallIntType;
import com.tencent.oceanus.shaded.org.apache.flink.table.types.logical.TimestampType;
import com.tencent.oceanus.shaded.org.apache.flink.table.types.logical.TinyIntType;
import com.tencent.oceanus.shaded.org.apache.flink.table.types.logical.VarCharType;
import com.tencent.oceanus.shaded.org.apache.flink.table.types.logical.utils.LogicalTypeDefaultVisitor;
...
/**
 * Convert LiteralExpr to setats value.
 */
public class SetatsValueConverter extends LogicalTypeDefaultVisitor<Object> {
    private LiteralExpr expr;

    public SetatsValueConverter(LiteralExpr expr) {
        this.expr = expr;
    }

    public BinaryStringData visit(VarCharType varCharType) {
        return BinaryStringData.fromString(expr.getStringValue());
    }

    public BinaryStringData visit(CharType charType) {
        // Currently, Setats does not support predicate push-down for char
        return null;
    }
