...
import com.tencent.oceanus.setats.shaded.org.apache.iceberg.CatalogProperties;
import com.tencent.oceanus.setats.shaded.org.apache.iceberg.catalog.Catalog;
import com.tencent.oceanus.setats.shaded.org.apache.iceberg.hadoop.HadoopCatalog;
import org.apache.commons.lang3.StringUtils;
import org.apache.hadoop.conf.Configuration;

import java.util.Map;

public class SetatsHadoopExternalCatalog extends SetatsExternalCatalog {

    public SetatsHadoopExternalCatalog(long catalogId, String name, String resource, Map<String, String> props,
            String comment) {
        ...
        Preconditions.checkArgument(StringUtils.isNotEmpty(warehouse),
                "Cannot initialize Setats HadoopCatalog because 'warehouse' must not be null or empty");
    ...
    protected Catalog initCatalog() {
        setatsCatalogType = SETATS_HADOOP;
        HadoopCatalog hadoopCatalog = new HadoopCatalog();
        Configuration conf = getConfiguration();
        // initialize hive catalog
        Map<String, String> catalogProperties = getProperties();
        String warehouse = catalogProperty.getHadoopProperties().get(SetatsProperties.WAREHOUSE);
        hadoopCatalog.setConf(conf);
        catalogProperties.put(CatalogProperties.WAREHOUSE_LOCATION, warehouse);
        hadoopCatalog.initialize(setatsCatalogType, catalogProperties);
