...
# JAVA_OPTS LOG_DIR PID_DIR and etc.
...
if [[ -d "${DORIS_HOME}/custom_lib/fe" ]]; then
    for f in "${DORIS_HOME}/custom_lib/fe"/*.jar; do
...
export CLASSPATH="${DORIS_HOME}/conf:${CLASSPATH}:${DORIS_HOME}/lib/fe"
