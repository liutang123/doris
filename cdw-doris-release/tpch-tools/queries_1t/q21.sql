...
select /*+SET_VAR(exec_mem_limit=60129542144, parallel_fragment_exec_instance_num=16, batch_size=8192, disable_join_reorder=true, enable_cost_based_join_reorder=true, enable_projection=true) */
