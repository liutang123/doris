...
public:
    ...
    Status execute_impl(FunctionContext* context, Block& block, const ColumnNumbers& arguments,
        ...
        auto ptr = col_json.convert_to_full_column_if_const();
        const ColumnString* col_json_string = &assert_cast<const ColumnString&>(*ptr.get());

        auto ptr1 = col_search.convert_to_full_column_if_const();
        const ColumnString* col_search_string = &assert_cast<const ColumnString&>(*ptr1.get());

        auto ptr2 = col_path.convert_to_full_column_if_const();
        const ColumnString* col_path_string = &assert_cast<const ColumnString&>(*ptr2.get());
